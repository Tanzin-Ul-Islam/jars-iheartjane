...
import { useGetLandingPageCmsQuery, useGetRetailerDataMutation } from '../../redux/api_core/apiCore';

export default function PickupPage(){
    const router = useRouter()

    const { data, isSuccess, isFetching, error } = useGetLandingPageCmsQuery({});
    const [getRetiarls, result] = useGetRetailerDataMutation({});
                ...
                <div className="col-12 col-md-7 col-lg-5 p-0">
                    <div className="bg-white py-5  d-flex flex-column justify-content-between">
                        ...
                        <div className="p-4 text-center">
                            <h2 className="fs-20 ff-powerGrotesk600 mb-4">{data?.data[0].pickUpPageTitle}</h2>
